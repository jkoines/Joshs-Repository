...
<img src="{{ site.baseurl }}/static/imgs/line_graph.png" alt="Line Graph"  width="500"/>
<img src="{{ site.baseurl }}/static/imgs/freq_table1.png" alt="Freq_table1"  width="500"/>
<img src="{{ site.baseurl }}/static/imgs/freq_table2.png" alt="Freq_table2"  width="500"/>

The data shows that most people find the lesson videos to be effective and want to have a livestream of the lecture online. This is shown by the two frequency tables that are significantly skewed right, and the line graph that shows a clear correlation between a student taking notes -- a sign of academic standing -- and finding lesson videos to be effective. The evidence shows that the COMP 110 curriculum should implement a virtual lecture so that students can use videos and livestreams  to suppliment or eventually repflace in-person lectures. While this can cut down resources for the University and help those who prefer a virtual lecture, it may be harmful for the education of those who prefer in-person lectures and would not want the curriculum's educational priority to shift toward virtual lectures. Therefore, in the short-term, it is best to keep the virtual lecture to be optional and supplemental rather than becoming a replacement for the in-person lecture. Ultimately, COMP 110 should impliment a virtual lecture option due to the educational preferences of the students and the correlation between academic standing and lesson video viewership.